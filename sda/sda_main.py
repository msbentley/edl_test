...
layout=html.Div([
    ...
    dcc.Store(id='signal'),
    dcc.Store(id='extsignal'),
    dcc.Store(id='extmapsignal'),
        ...
        html.Div([
            ...
            html.Div([
                dcc.Dropdown(
                    id='cube-dropdown',
                    options=[
                        {'label':'V1: Resolution 25pc (sampling: 10pc - size: 6 x 6 x 0.8 kpc)', 'value': 'cube1'},
                        {'label':'V1: Resolution 50pc (sampling: 20pc - size: 10 x 10 x 0.8 kpc)', 'value': 'cube2'},
                        {'label':'V2: Resolution 10pc (sampling: 5pc - size: 3 x 3 x 0.8 kpc)', 'value': 'cube1_v2'},
                        {'label':'V2: Resolution 25pc (sampling: 10pc - size: 6 x 6 x 0.8 kpc)', 'value': 'cube2_v2'},
                        {'label':'V2: Resolution 50pc (sampling: 20pc - size: 10 x 10 x 0.8 kpc)', 'value': 'cube3_v2'},
                    ],
                    value='cube3_v2',
                    clearable=False,
        ...
        html.Div([
            dcc.Tabs(
                ...
                children=[
                    ...
                    dcc.Tab(label='Integrated extinction', value='tab-1c'),
                    dcc.Tab(label='Extinction maps', value='tab-2'),
                    dcc.Tab(label='Sky Extinction maps', value='tab-extmap'),
