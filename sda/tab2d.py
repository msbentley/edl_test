...
def on_submit_2d(clicks, clicks_save,frame,lon_orig,lat_orig,dist_orig,lon_norm,lat_norm, cubename):
    ...
    if clicks==0 or clicks is None:
        ...
        if cubename == 'cube1':
            ...
            selectedcube = "Cube v1: Resolution 25pc (sampling: 10pc - size: 6 x 6 x 0.8 kpc)"
        if cubename == 'cube2':
            ...
            selectedcube = "Cube v1: Resolution 50pc (sampling: 20pc - size: 10 x 10 x 0.8 kpc)"
        if cubename == 'cube1_v2':
            result, X, Y, Z = cube_cut(globals.cube_v2_10, globals.hw_v2_10, globals.step_v2_10, globals.points_v2_10, globals.s_v2_10, lon_orig, ulon, lat_orig, ulat, frame, dist_orig, udist, lon_norm, unlon, lat_norm, unlat)
            selectedcube = "Cube v2: Resolution 10pc (sampling: 5pc - size: 3 x 3 x 0.8 kpc)"
        if cubename == 'cube2_v2':
            result, X, Y, Z = cube_cut(globals.cube_v2_25, globals.hw_v2_25, globals.step_v2_25, globals.points_v2_25, globals.s_v2_25, lon_orig, ulon, lat_orig, ulat, frame, dist_orig, udist, lon_norm, unlon, lat_norm, unlat)
            selectedcube = "Cube v2: Resolution 25pc (sampling: 10pc - size: 6 x 6 x 0.8 kpc)"
        if cubename == 'cube3_v2':
            result, X, Y, Z = cube_cut(globals.cube_v2_50, globals.hw_v2_50, globals.step_v2_50, globals.points_v2_50, globals.s_v2_50, lon_orig, ulon, lat_orig, ulat, frame, dist_orig, udist, lon_norm, unlon, lat_norm, unlat)
            selectedcube = "Cube v2: Resolution 50pc (sampling: 20pc - size: 10 x 10 x 0.8 kpc)"
        ...
        parsed_input = html.Div([
            ...
            html.Pre(str(X.shape)),
            html.Pre(str(Y.shape)),
            html.Pre(str(Z.shape)),
        ])
