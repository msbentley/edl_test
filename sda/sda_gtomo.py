...
if __name__ == '__main__':
    ...
    try:
        ...
        #print(port, debug)
        sda.run_server(host='0.0.0.0', debug=True, port=port, threaded=False, processes=4)
    except:
        sda.run_server(host='0.0.0.0', debug=True, port=8050, threaded=False, processes=4)
